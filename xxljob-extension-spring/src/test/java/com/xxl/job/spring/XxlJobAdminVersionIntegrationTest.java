...
import com.xxl.job.spring.mock.MockXxlJobAdminServer.XxlJobRequestLog;
import com.xxl.job.spring.mock.MockXxlJobAdminServer;
...
class XxlJobAdminVersionIntegrationTest {
    ...
    void shouldCompleteAdminFlowForVersion(AdminVersion version) throws Exception {
        ...
        XxlJobAdminConfig config = XxlJobAdminConfig.builder()
                ...
                .addresses(mockAdmin.getBaseUrl())
                .username("admin")
                .password("123456")
                .version(version)
                .build();
        XxlJobAdminClient adminClient = new DefaultXxlJobAdminClient(Unirest.spawnInstance(), config);
