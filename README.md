...
```gradle
implementation 'io.github.easy4j:xxljob-extension-core:3.0.x.x.20260630-SNAPSHOT'
implementation 'io.github.easy4j:xxljob-extension-spring:3.0.x.x.20260630-SNAPSHOT'
```
