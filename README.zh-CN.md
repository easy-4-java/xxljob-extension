...
[![Java](https://img.shields.io/badge/Java-21-orange)](https://github.com/easy-4-java/xxljob-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](https://www.apache.org/licenses/LICENSE-2.0.txt)
...
| `xxl-job-core`（兼容基线） | 3.4.2 |
| Spring 集成（spring 模块） | `spring-context` 7.0.8；不依赖 Spring Boot 或 Micrometer |
...
本文档描述 `feature/3.0.x` 版本线（当前版本：`3.0.x.20260630-SNAPSHOT`）。
...
```gradle
implementation 'io.github.easy4j:xxljob-extension-core:3.0.x.20260630-SNAPSHOT'
implementation 'io.github.easy4j:xxljob-extension-spring:3.0.x.20260630-SNAPSHOT'
```
